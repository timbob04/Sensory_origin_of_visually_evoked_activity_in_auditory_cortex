...
med_VvsVO = -0.443; % from the FR change values
med_VvsVO_diff = -1.92; % from the differences in FRs
...
plot([med_VvsVO med_VvsVO],YLIM,'k:','linewidth',1)
...
% saveFig(fullfile(saveFigFol,'histogram'),'-dpdf')
